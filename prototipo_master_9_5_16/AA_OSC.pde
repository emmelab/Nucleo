...
void initOSC() {
  ...
  oscP5.plug(this, "seleccionarEstimulo", "/seleccionar/estimulo");
}
...
void mensaje_AGREGARmod(String agregado) {
  OscMessage mensajeModificadores ;
  mensajeModificadores = new OscMessage("/agregarMod");
  mensajeModificadores.add(agregado);
  oscP5.send(mensajeModificadores, consola);
}

void mensaje_QUITARmod(String eliminado) {
  OscMessage mensajeModificadores ;
  mensajeModificadores = new OscMessage("/quitarMod");
  mensajeModificadores.add(eliminado);
  oscP5.send(mensajeModificadores, consola);
}
